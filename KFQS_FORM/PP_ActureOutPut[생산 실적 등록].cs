...
namespace KFQS_Form
{
    public partial class PP_ActureOutPut : DC00_WinForm.BaseMDIChildForm
    {
        ...
        private void PP_ActureOutPut_Load(object sender, EventArgs e)
        {
            ...
            rtnDtTemp = _Common.Standard_CODE("WORKCENTERCODE");  // 사업장
        ...
        public override void DoInquire()
        {
            ...
            {
                // 작업지시 조회
                string sPantCode        = Convert.ToString(cboPlantCode.Value);
                ...
                rtnDtTemp = helper.FillTable("PP_ActureOutPut_S1", CommandType.StoredProcedure
                                              , helper.CreateParameter("PLANTCODE"      , sPantCode, DbType.String, ParameterDirection.Input)
